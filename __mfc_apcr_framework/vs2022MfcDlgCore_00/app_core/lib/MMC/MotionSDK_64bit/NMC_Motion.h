...
#endif
    NMCMOTIONAPI MC_STATUS
    MC_GetMismatchErrorInfo(UINT16  BoardID,
...
#endif
    NMCMOTIONAPI MC_STATUS
    MasterGet_DI_DeviceTotalChSize(
      UINT16  BoardID,
      UINT16  DeviceID,
...
#endif
    NMCMOTIONAPI MC_STATUS
    MasterGet_DO_DeviceTotalChSize(
      UINT16  BoardID,
      UINT16  DeviceID,
      UINT16 *DeviceTotalChSize);
...
#endif
    NMCMOTIONAPI MC_STATUS
    MasterGet_AI_DeviceTotalChSize(
      UINT16  BoardID,
      UINT16  DeviceID,
      UINT16 *DeviceTotalChSize);
...
#endif
    NMCMOTIONAPI MC_STATUS
    MasterGet_AO_DeviceTotalChSize(
      UINT16  BoardID,
      UINT16  DeviceID,
      UINT16 *DeviceTotalChSize);
...
#endif
    NMCMOTIONAPI MC_STATUS
    MC_IO_GetMaskedDigitalOutputBit(
      UINT16  BoardID,
      UINT16  EcatAddr,
      UINT16  SlaveOffset,
      UINT8   OutputBitNumber,
...
#endif
    NMCMOTIONAPI MC_STATUS
    MC_ChangeErrorCompensationMode(
      UINT16 BoardID,
      UINT16 AxisID[3],
      UINT8  Type,
      UINT16 Mode,
...
#endif
    NMCMOTIONAPI MC_STATUS
    MC_ReadErrorCompensationStatus(
      UINT16 BoardID,
      UINT8  ECMapID,
      UINT16 AxisID[3],
      UINT8 *Type,
...
#endif
    NMCMOTIONAPI MC_STATUS
    MC_WriteErrorCompensationDataFile(
      UINT16 BoardID,
      UINT16 ECType,
      UINT8  ECMapID,
...
#endif
    NMCMOTIONAPI MC_STATUS
    RSA_UploadDataAISynchronizedAxis(
      UINT16  BoardID,
      UINT16  AxisID,
      UINT16  UploadCount,
...
#endif
    NMCMOTIONAPI MC_STATUS
    MC_ChangeTorqueLimitPositionEvent(
      UINT16 BoardID,
      UINT16 AxisID,
...
#endif
    NMCMOTIONAPI MC_STATUS
    MC_WriteIntervalTrigParameterFM(
      UINT16 BoardID,
      UINT16 EcatAddr,
      UINT16 AxisID,
