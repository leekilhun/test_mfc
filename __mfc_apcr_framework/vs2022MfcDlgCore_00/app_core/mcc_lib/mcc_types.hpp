 ...
 * @brief machien control cpp common types
 * @version 0.1
 * @date 2025-02-18
 * 
...
namespace mcc
{
  ...
  template <typename P>
  concept str_or_wstr_type_c = std::same_as<P, std::string> || std::same_as<P, std::wstring>;

  template <typename P>
  concept ptr_str_or_ptr_wstr_type_c = std::same_as<P, const char *> || std::same_as<P, const wchar_t *>;
