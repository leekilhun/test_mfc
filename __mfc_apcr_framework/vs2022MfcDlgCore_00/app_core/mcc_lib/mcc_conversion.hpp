...
namespace mcc
{
  mcC_inLine std::string remove_stx_etx_crlf(std::string& org_str)
  {
    std::string new_str{};
    int         ngcnt = 0;
    for (auto &c : org_str)
    {
      if (c == 0x02) //|| c == '\n' || c == '\t')
        continue;
      if (c == '\n' || c == '\r' || c == '\t' || c == 0x03 || c == 0x00) //|| c == '\n' || c == '\t')
        break;

      new_str += c;
    }
    org_str = new_str;
    std::cout << "remvd str : " << org_str << std::endl;
    return new_str;
  } 
  namespace conversion
  {

    mcC_inLine std::wstring cchar_to_wstring(const char *str)
    {
      ...
      std::wstring ret_str = std::wstring{tszTemp};
      if (tszTemp)
      {
        delete[] tszTemp;
        tszTemp = NULL;
     ...
     *
     */
    mcC_inLine std::string wstring_to_string(const std::wstring &wstr, unsigned int codepage = CP_UTF8)
    {
    ...
    /**
      ...
      */
    mcC_inLine std::wstring string_to_wstring(const std::string &str, unsigned int codepage = CP_UTF8)
    {
     ...
     * @sa <a target ="_blank" href="002-conversion_8cpp_source.html">002-conversion.cpp</a>
     */
    mcC_inLine std::string utf16_to_utf8(const std::wstring &utf16str)
    {
     ...
     * @sa <a target ="_blank" href="002-conversion_8cpp_source.html">002-conversion.cpp</a>
     */
    mcC_inLine std::wstring utf8_to_utf16(const std::string &utf8str)
    {
      if (utf8str.empty())
        return L"";
     ...
     * @sa <a target ="_blank" href="002-conversion_8cpp_source.html">002-conversion.cpp</a>
     */
    mcC_inLine std::string utf16_to_utf8(const wchar_t *utf16str)
    {
     ...
     * @sa <a target ="_blank" href="002-conversion_8cpp_source.html">002-conversion.cpp</a>
     */
    mcC_inLine std::wstring utf8_to_utf16(const char *utf8str)
    {
     ...
     * @sa <a target ="_blank" href="002-conversion_8cpp_source.html">002-conversion.cpp</a>
     */
    mcC_inLine char utf16_to_utf8(const wchar_t utf16_char)
    {
