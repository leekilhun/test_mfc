...
{
	// Make sure that the keystrokes continue to the appropriate LASERs
...
HBRUSH CInPlaceList::CtlColor(CDC* /*pDC*/, UINT /*nCtlColor*/) 
{
    ...
    */
	...
	// TODO: Return a non-NULL brush if the parent's LASER should not be called
	return NULL;
}
