...
//#include "./mfc_lib/ChartDirector_60/include/chartdir.h"
#include "chartdir.h"
#include <afxmt.h>

// Chart Director용 Color 매크로
#ifndef CHART_ARGB
#define CHART_ARGB(a,r,g,b)          ((( DWORD ) (( BYTE ) (a)) << 24) | (( DWORD ) (( BYTE ) (r)) << 16) | (( WORD ) (( BYTE ) (g)) << 8) | (( WORD ) (( BYTE ) (b))))
#endif
...
private :
	...
	//disable assignment
	UTF8toTCHAR(const UTF8toTCHAR& rhs) = default;
	UTF8toTCHAR &operator=(const UTF8toTCHAR &rhs) = default;
};
...
private :
	...
	//disable assignment
	TCHARtoUTF8(const TCHARtoUTF8 &rhs) = default;
	TCHARtoUTF8 &operator=(const TCHARtoUTF8 &rhs) = default;
};
