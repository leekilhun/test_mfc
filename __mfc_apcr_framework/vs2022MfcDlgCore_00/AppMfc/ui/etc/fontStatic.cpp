...
// 
//  https://www.codeproject.com/Articles/7377/CFontStatic
//
/////////////////////////////////////////////////////////////////////////////
...
void CFontStatic::OnPaint()
{
	...
	// Create the font
	fFont.Detach();
	if (fFont.CreateFont(m_nSize, 0, 0, 0, nWeight, (DWORD)m_bItalic
		, (DWORD)m_bUnderlined, (DWORD)m_bStrikethrough, (DWORD)(DEFAULT_CHARSET), (DWORD)OUT_CHARACTER_PRECIS, (DWORD)CLIP_CHARACTER_PRECIS
		, (BYTE)dwQuality,(DWORD)( DEFAULT_PITCH | FF_DONTCARE), m_szFont) != NULL)
	{
		fOldFont = dc.SelectObject(&fFont);
		dc.DrawText(szText, rect, unFormat);
	}
	else
		AfxMessageBox(L"Font could not be created!");
